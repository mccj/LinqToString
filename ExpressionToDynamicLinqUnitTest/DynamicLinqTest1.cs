...
namespace ExpressionToDynamicLinqUnitTest.ExpressionPredicate
{
    ...
    public class DynamicLinqTest : PredicateTestBase
    {
        ...
        public void Dynamic静态方法Test()
        {
            ...
            var s1 = expression1.ToPredicateExpression();
        ...
        //    var a3 = dddd.Where("(@0.Contains(root.Name))", new object[] { new[] { "111", "222", "333" } });
        //    var a4 = dddd.Where("(B8.Contains(root.Name))", new object[] { new[] { "111", "222", "333" } });
        ...
        public void DynamicNewTest4()
        {
            ...
            var s1 = expression1.ToPredicateExpression();
            var s2 = expression2.ToPredicateExpression();
            var s3 = expression3.ToPredicateExpression();
