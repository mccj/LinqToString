...
using ExpressionToDynamicLinqUnitTest.ToExpressionTest;
...
namespace ExpressionToDynamicLinqUnitTest.ExpressionString
{
    ...
    public class DynamicLinqTest: PredicateTestBase
    {
        ...
        //    var s1 = dddd.Select("new()");
        //    var s2 = dddd.Select("new(\"aaa\" as eeee)");
        //    var s3 = dddd.Select("new(55 as eeee)");
        //    //var s4 = dddd.Select("new([5,6,8] as eeee)");
        //}
        [TestMethod]
        ...
        //    var a3 = dddd.Where("(@0.Contains((it).Name))", new object[] { new[] { "111", "222", "333" } });
        //    var a4 = dddd.Where("(B8.Contains((it).Name))", new object[] { new[] { "111", "222", "333" } });
        ...
        public void DynamicNewTest4()
        {
            ...
            var a1 = dddd.Select("new(\"hhhhhh\" as sss,(it).Name as Name,new(\"dd\" as name) as ooo)");
            ...
            var s1 = expression1.ToStringExpression();
            var s2 = expression2.ToStringExpression();
            var s3 = expression3.ToStringExpression();
            var s11 = dddd.Select(s1);
            var s21 = dddd.Select(s2);
            var s31 = dddd.Select(s3);
            //Assert.AreEqual(s1, "new(\"hhhhhh\" as sss,(it).Name as Name,new(\"dd\" as Name) as ooo)");
            //Assert.AreEqual(s2, "new(\"hhhhhh\" as sss,(it).Name as Name,new(\"dd\" as Name) as ooo)");
            //Assert.AreEqual(s3, "new(\"hhhhhh\" as sss,(it).Name as Name,new(\"dd\" as Name) as ooo)");
        }
        public class A
        {
