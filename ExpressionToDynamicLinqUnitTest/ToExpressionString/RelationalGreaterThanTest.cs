...
{
    [TestClass]
    public class RelationalGreaterThanTest
    {
        //[TestMethod]
        ...
        public void GreaterThanOrEqualDateTime()
        {
            ...
            Expression<Func<Model1, bool>> expression3 = f => (Convert.ToDateTime("2012,1,1") > f.B5.B2);
            var s3 = expression3.ToExpressionString();
            ...
            Assert.AreEqual(s3, "(Convert.ToDateTime(\"2012,1,1\") > (it).B5.B2)");
